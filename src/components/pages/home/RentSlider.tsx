  ...
  const slides = [
    {
      ...
      text,
      img: '/images/items-rent/pic-1.png',
    },
    { title: 'Экскаваторы', text, img: '/images/items-rent/pic-2.webp' },
    { title: 'Бульдозеры', text, img: '/images/items-rent/pic-3.webp' },
    {
      title: 'Краны строительные',
      text,
      img: '/images/items-rent/pic-4.webp',
    },
    { title: 'Самосвалы', text, img: '/images/items-rent/pic-5.webp' },
    { title: 'Гидромолот', text, img: '/images/items-rent/pic-6.webp' },
  ]
              ...
              <div className="rent__slider-item slider-item" key={idx}>
                <div className="slider-item__body flex">
                  ...
                  <div className="slider-item__info rel">
                    ...
                    <a 
                      className="slider-item__link btn"
                      href={ROUTES.CATALOG}
                    >
                      Выбрать спецтехнику
                    </a>
